...
from utils.aws import create_custom_assistant, get_custom_assistants, delete_custom_assistant, update_section_assistant
...
def get_assistant_instructions(section):
    """
